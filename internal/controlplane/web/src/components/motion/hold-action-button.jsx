"use client";;
// Machinist: the wave inherits the fill colour, so fillClassName themes both,
// and hides while idle — otherwise its crest shows inside a short button.
    ...
    >
      ...
      >
        <motion.span
          ...
          className={cn(
            "absolute inset-0 bg-sky-400 text-sky-400 will-change-[opacity,transform]",
            fillClassName,
          )}
        >
          {!reduce ? (
            type === "horizontal" ? (
              <motion.svg
                ...
                className="absolute -right-5 top-0 h-[200%] w-6"
              >
                <path
              ...
              <motion.svg
                ...
                className="absolute -top-5 left-0 h-6 w-[200%]"
              >
                <path
